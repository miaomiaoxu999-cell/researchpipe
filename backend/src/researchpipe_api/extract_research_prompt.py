"""Prompt for /v1/extract/research — same as eval/src/prompts/extract_research.py.

Validated in W1 (2026-04-29) at 9/9 schema_ok on 9 reports.
"""
...
def build_messages(*, full_text: str, source_url: str = "", hint_title: str = "") -> tuple[str, str]:
